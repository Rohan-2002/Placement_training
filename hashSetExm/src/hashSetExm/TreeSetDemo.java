...
/*
 * Output :
 			Courses are : [C++, Core Java, Hibernate, JavaScript, Python, Springboot]
			Course Subset is [JavaScript, Python, Springboot]
			After adding HTML and React in main course set
			
			Courses are [C++, Core Java, HTML, Hibernate, JavaScript, Python, React, Springboot]
			Course Subset is [JavaScript, Python, React, Springboot]
			After removing Python from main course set
			
			Courses are [C++, Core Java, HTML, Hibernate, JavaScript, React, Springboot]
			Course Subset is [JavaScript, React, Springboot]
			[10, 20, 30, 60, 80]
			[10, 20, 30, 60, 80]
			[60]
			[10, 20, 30, 50, 60, 80, 400]
			[50, 60]
			[10, 20, 30, 35, 50, 60, 80, 400]
			[35, 50, 60]
 */
